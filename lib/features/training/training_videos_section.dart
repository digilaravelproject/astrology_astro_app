...
class TrainingVideosSection extends StatelessWidget {
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              TextButton(
                onPressed: () => Get.to(() => const TrainingVideosListScreen()),
                child: AppText(
                  'View All',
                  fontSize: 14,
  ...
  Widget _buildVideoCard(String title, int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: index == 0 ? const Color(0xFFFFEB3B) : (index == 1 ? const Color(0xFFFFF176) : const Color(0xFFFFF9C4)),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: Center(
                  child: Icon(Icons.smartphone_rounded, color: Colors.grey.shade300, size: 40),
                ),
              ),
            ),
          ),
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.refresh_rounded, size: 14, color: Colors.black54),
                  ),
                ),
              ],
            ),
