...
import 'package:astro_astrologer/features/language/data/models/language_model.dart';
import 'package:astro_astrologer/features/language/widget/language_bottom_sheet.dart';
  ...
  void setLanguage(LanguageModel language) {
    ...
    if (index != -1) {
      ...
      if (Get.isRegistered<RemedyController>()) {
        Get.find<RemedyController>().getRemedies();
      }
    }
  }
