...
import 'presentation/controllers/notice_controller.dart';
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const AppText('No Notices Yet'.tr,
            fontSize: 18,
            fontWeight: FontWeight.w700,
            color: Color(0xFF2E1A47),
          ),
          const SizedBox(height: 8),
          const AppText('Important announcements from admin\nwill appear here.'.tr,
            fontSize: 14,
